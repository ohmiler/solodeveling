...
@pytest.mark.parametrize(
    ...
    [
        ("win32", "AMD64", ("win32-x64", "solodeveling-0.1.0-windows-x64.exe")),
        ("win32", "ARM64", ("win32-arm64", "solodeveling-0.1.0-windows-arm64.exe")),
        ("darwin", "x86_64", ("darwin-x64", "solodeveling-0.1.0-macos-x64")),
        ("darwin", "arm64", ("darwin-arm64", "solodeveling-0.1.0-macos-arm64")),
        ("linux", "x86_64", ("linux-x64", "solodeveling-0.1.0-linux-x64")),
        ("linux", "aarch64", ("linux-arm64", "solodeveling-0.1.0-linux-arm64")),
    ],
)
...
def test_native_builder_includes_canonical_resources(
    ...
    assert built.name == "solodeveling-0.1.0-windows-x64.exe"
...
def test_native_builder_refuses_existing_output_before_runner(
    ...
    output = tmp_path / "native"
    output.mkdir()
    destination = output / "solodeveling-0.1.0-linux-x64"
