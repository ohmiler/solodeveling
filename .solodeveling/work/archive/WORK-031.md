...
next_action: Request a fresh pilot-3 authorization only if another 18 live calls are worthwhile.
evidence:
- EVIDENCE-031
---
...
PR #35 passed the full CI matrix and merged as
`ccedb251a2d4800ed05f82e74dc40250d0b601c6`. Post-merge main CI run
`29512717698` also passed. Pilot-3 remains not run.
